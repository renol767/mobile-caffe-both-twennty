...
class TransactionServices {
  ...
  static Future<ApiReturnValue<List<Transaction>>> getTransactions() {
    ...
    return http
        .get(
            "http://192.168.1.11/caffe-booth-twenty/api/transaction?Token=0a66838fcbd880483b9af2c91c6cef9e&uid=$uid")
        .then((data) {
  ...
  //       "http://192.168.1.11/caffe-booth-twenty/api/transaction?Token=0a66838fcbd880483b9af2c91c6cef9e",
